...
// then hand control back to the WebView once Supabase's session
...
// to your configured deep link (farmplugai://auth/callback) -> Android
// intent-filter catches it -> app passes the resulting URL back into
// the WebView's existing /auth/callback page to complete
