...
@media(max-width:800px){
  body{padding-left:0;padding-bottom:76px}.desktopSidebar,.desktopMenuButton{display:none}.mobileMenuButton{position:fixed;display:grid;place-items:center;left:12px;top:12px;width:42px;height:42px;z-index:110;border:1px solid #dce8df;border-radius:13px;background:rgba(255,255,255,.96);color:#166534;box-shadow:0 8px 25px rgba(16,37,26,.12)}.sideOverlay{position:fixed;display:block;inset:0;background:rgba(8,22,13,.38);z-index:125}.mobileSidebar{position:fixed;display:flex;flex-direction:column;left:0;top:0;bottom:0;width:min(84vw,330px);z-index:130;background:#fff;padding:20px 15px;box-shadow:15px 0 45px rgba(0,0,0,.16);transform:translateX(-105%);transition:transform .22s ease}.mobileSidebar.open{transform:translateX(0)}.mobileSidebar .sideBrand{padding-right:0}.mobilePageHead{padding-left:64px}.pageShell{max-width:760px;padding-bottom:24px}.bottomNav{position:fixed;display:grid;grid-template-columns:repeat(5,1fr);left:8px;right:8px;bottom:8px;height:64px;z-index:120;background:rgba(255,255,255,.97);backdrop-filter:blur(18px);border:1px solid #dfe9e2;border-radius:20px;box-shadow:0 10px 35px rgba(16,37,26,.16);padding:4px}.bottomItem{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;border-radius:15px;color:#708077;text-decoration:none;font-size:9px;font-weight:700;min-width:0}.bottomItem.active{background:#eaf8ed;color:#166534}.bottomItem svg{flex:none}.sideFooter{padding-bottom:8px}
}
@media(max-width:480px){.pageHero h1{font-size:40px}.miniGrid,.dashboardGrid{grid-template-columns:1fr 1fr}.bottomNav{height:62px}.bottomItem{font-size:8px}}
`;
